...
def gen_atoms(
    ...
    custom_eos = tokenizer.encode(">", add_special_tokens=False)[0]
    outputs = model.generate(
        **inputs, max_new_tokens=max_new_tokens, use_cache=True, eos_token_id=[tokenizer.eos_token_id, custom_eos],
    )
